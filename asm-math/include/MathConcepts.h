...
namespace asmmath
{
    ...
    /**
     * @brief Concept for safe numeric operations limiting LHS and RHS operand
     * to be both signed integrals, or unsigned integrals, or either of the two
     * being a floating point, since at least one floating point operand
     * implicitly suggest the requirement of a floating point operation.
     */
